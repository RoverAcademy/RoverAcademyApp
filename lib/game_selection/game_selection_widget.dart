...
class GameSelectionWidget extends StatefulWidget {
  ...
  static String routeName = 'GameSelection';
  static String routePath = '/gameSelection';
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: AutoSizeText(
                                                        'Solve the puzzle by answering questions. Every correct answer unlocks a piece of the puzzle. ',
                                                        textAlign:
                                                            TextAlign.start,
                                                        style:
                                                            FlutterFlowTheme.of(
