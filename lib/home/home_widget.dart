  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserDetailsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final homeUserDetailsRecord = snapshot.data!;
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                    () {
                                                      if (homeUserDetailsRecord
                                                          .lastGameWasMath) {
                                                        return 'Math';
                                                      } else if (homeUserDetailsRecord
                                                          .lastGameWasReading) {
                                                        return 'Reading';
                                                      } else if (homeUserDetailsRecord
                                                          .lastGameWasHistory) {
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    wrapWithModel(
                                      model: _model.leaderboardTItleModel,
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              'Score: ${listViewUserDetailsRecord.totalPoints.toString()}',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .titleLarge
                                                                  .override(
