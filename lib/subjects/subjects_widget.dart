                    ...
                    children: [
                                      ...
                                      unawaited(
                                        () async {
                                          await currentUserReference!.update(
                                            ...
                                            lastGameWasMath: true,
                                            lastGameWasHistory: false,
                                            lastGameWasReading: false,
                                          ));
                                        }(),
                                      );
                                    ...
                                    onTap: () async {
                                      unawaited(
                                        () async {
                                          await currentUserReference!.update(
                                              createUserDetailsRecordData(
                                            lastGameWasReading: true,
                                            lastGameWasHistory: false,
                                            lastGameWasMath: false,
                                          ));
                                        }(),
                                      );
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Text(
                            'Subject not here? Click here to request a subject!',
