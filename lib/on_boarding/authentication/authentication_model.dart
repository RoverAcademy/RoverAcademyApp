...
class AuthenticationModel extends FlutterFlowModel<AuthenticationWidget> {
  ...
  String gradeLevelChoice = '\"Kindergarten\"';
  ...
  // State field(s) for gradeLevel_Create widget.
  String? gradeLevelCreateValue;
  FormFieldController<String>? gradeLevelCreateValueController;
