...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: TimedQuizWidget.routeName,
          path: TimedQuizWidget.routePath,
          builder: (context, params) => TimedQuizWidget(
            subject: params.getParam(
              'subject',
              ParamType.int,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Subjects')
              : SubjectsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: GradeSelectionWidget.routeName,
          path: GradeSelectionWidget.routePath,
          builder: (context, params) => GradeSelectionWidget(
            subject: params.getParam(
              'subject',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: GameSelectionWidget.routeName,
          path: GameSelectionWidget.routePath,
          builder: (context, params) => GameSelectionWidget(
            subject: params.getParam(
              'subject',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: RoverBuddyWidget.routeName,
          path: RoverBuddyWidget.routePath,
          builder: (context, params) => params.isEmpty
